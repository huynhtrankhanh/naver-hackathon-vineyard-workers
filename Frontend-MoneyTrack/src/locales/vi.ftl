...
empty-state-verse = Kế hoạch người siêng năng hẳn tạo ra lợi nhuận
empty-state-citation = Châm ngôn 21:5a, KTCGKPV
empty-state-adjust-limits = Điều chỉnh Giới hạn Chi tiêu
empty-state-record-transaction = Ghi Giao dịch Mới
...
budget-limits = Giới hạn Ngân sách
...
# Budget
add-new-budget = Thêm Ngân sách Mới
edit-budget-limit = Sửa Giới hạn Ngân sách
category = Danh mục
limit = Giới hạn
spent = Đã chi
remaining = Còn lại
...
contribution-amount = Số tiền Đóng góp (VND)
goal-progress = Tiến độ mục tiêu
remaining-to-target = Còn lại để đạt mục tiêu
balance-after-contribution = Số dư sau khi đóng góp
suggestion-per-month = Gợi ý: { $amount } / tháng
...
title = Tiêu đề
title-placeholder = VD: Cà phê tại Highlands
date-time = Ngày & Giờ
balance-preview = Xem trước Số dư
current-balance-label = Số dư hiện tại:
original-transaction = Giao dịch gốc:
...
# Income
no-income = Chưa có thu nhập. Thêm từ trang Thêm Giao dịch.

# Transactions by Month
transactions-by-month = Giao dịch theo Tháng
no-transactions-month = Không tìm thấy giao dịch trong tháng này.
